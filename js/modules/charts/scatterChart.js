  ...
  const chart = new Chart(ctx, {
    ...
    data: {
      datasets: boroughs.map((borough, index) => ({
        ...
        backgroundColor: withAlpha(palette.boroughs[index % palette.boroughs.length], 0.35),
        hoverBackgroundColor: withAlpha(palette.boroughs[index % palette.boroughs.length], 0.55),
        borderWidth: 1.5,
        parsing: false,
      })),
    },
